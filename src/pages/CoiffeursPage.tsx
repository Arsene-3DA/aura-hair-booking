...
const CoiffeursPage = () => {
  ...
  const { professionals, loading, error } = useProfessionalsByRole('coiffeur');
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center">
              <h1 className="text-4xl font-bold mb-4 text-white">
                Nos <span className="text-[#FFD700]">Coiffeurs Experts</span>
              </h1>
          ...
          <div className="container mx-auto px-4">
            {loading ? (
              <div className="text-center py-16">
                ...
                <p className="text-gray-300 text-lg">Chargement des coiffeurs...</p>
              </div>
              ...
              <div className="text-center py-16">
                <p className="text-gray-300 text-lg mb-4">
                  Aucun coiffeur trouvé pour le moment.
                </p>
                <p className="text-gray-500 text-sm mb-6">
                  Nos coiffeurs seront bientôt disponibles sur la plateforme.
                </p>
