-- Mise à jour du trigger de validation pour mieux gérer les fuseaux horaires
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    -- Use a small buffer (1 hour) to account for timezone differences and processing time
