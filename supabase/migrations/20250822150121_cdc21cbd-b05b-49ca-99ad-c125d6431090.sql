-- Corriger la fonction pour inclure les créneaux de 9h00 à 21h30
...
BEGIN
  ...
  -- Générer tous les créneaux de 9h00 à 21h30 par défaut
  RETURN QUERY
  WITH time_slots AS (
    SELECT 
      to_char(slot_time_raw, 'HH24:MI') as slot_time_str,
      (check_date::date + slot_time_raw) as slot_time
